...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    {
        return $this->services['auth.provider.oauth'] = new \phpbb\auth\provider\oauth\oauth($this->get('dbal.conn'), $this->get('config'), $this->get('passwords.manager'), $this->get('request'), $this->get('user'), 'phpbb2_oauth_tokens', 'phpbb2_oauth_states', 'phpbb2_oauth_accounts', $this->get('auth.provider.oauth.service_collection'), 'phpbb2_users', $this, $this->get('dispatcher'), './', 'php');
    }
    ...
    {
        return $this->services['config'] = new \phpbb\config\db($this->get('dbal.conn'), $this->get('cache.driver'), 'phpbb2_config');
    }
    ...
    {
        return $this->services['config_text'] = new \phpbb\config\db_text($this->get('dbal.conn'), 'phpbb2_config_text');
    }
    ...
    {
        return $this->services['content.visibility'] = new \phpbb\content_visibility($this->get('auth'), $this->get('config'), $this->get('dispatcher'), $this->get('dbal.conn'), $this->get('user'), './', 'php', 'phpbb2_forums', 'phpbb2_posts', 'phpbb2_topics', 'phpbb2_users');
    }
    ...
    {
        $instance = new \phpbb\captcha\plugins\qa('phpbb2_captcha_questions', 'phpbb2_captcha_answers', 'phpbb2_qa_confirm');
    ...
    {
        return $this->services['ext.manager'] = new \phpbb\extension\manager($this, $this->get('dbal.conn'), $this->get('config'), $this->get('filesystem'), 'phpbb2_ext', './', 'php', $this->get('cache'));
    }
    ...
    {
        return $this->services['log'] = new \phpbb\log\log($this->get('dbal.conn'), $this->get('user'), $this->get('auth'), $this->get('dispatcher'), './', 'adm/', 'php', 'phpbb2_log');
    }
    ...
    {
        return $this->services['migrator'] = new \phpbb\db\migrator($this, $this->get('config'), $this->get('dbal.conn'), $this->get('dbal.tools'), 'phpbb2_migrations', './', 'php', 'phpbb2_', $this->get('migrator.tool_collection'), $this->get('migrator.helper'));
    }
    ...
    {
        return $this->services['migrator.tool.module'] = new \phpbb\db\migration\tool\module($this->get('dbal.conn'), $this->get('cache'), $this->get('user'), $this->get('module.manager'), './', 'php', 'phpbb2_modules');
    }
    ...
    {
        return $this->services['module.manager'] = new \phpbb\module\module_manager($this->get('cache.driver'), $this->get('dbal.conn'), $this->get('ext.manager'), 'phpbb2_modules', './', 'php');
    }
    ...
    {
        return new \phpbb\notification\method\board($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('config'), 'phpbb2_notification_types', 'phpbb2_notifications');
    }
    ...
    {
        $instance = new \phpbb\notification\type\admin_activate_user($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'phpbb2_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\approve_post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'phpbb2_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\approve_topic($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'phpbb2_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\bookmark($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'phpbb2_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\disapprove_post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'phpbb2_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\disapprove_topic($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'phpbb2_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\group_request($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'phpbb2_user_notifications');
    ...
    {
        return new \phpbb\notification\type\group_request_approved($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'phpbb2_user_notifications');
    }
    ...
    {
        $instance = new \phpbb\notification\type\pm($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'phpbb2_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'phpbb2_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\post_in_queue($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'phpbb2_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\quote($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'phpbb2_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_pm($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'phpbb2_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_pm_closed($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'phpbb2_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'phpbb2_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_post_closed($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'phpbb2_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\topic($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'phpbb2_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\topic_in_queue($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'phpbb2_user_notifications');
    ...
    {
        return $this->services['notification_manager'] = new \phpbb\notification\manager($this->get('notification.type_collection'), $this->get('notification.method_collection'), $this, $this->get('user_loader'), $this->get('dispatcher'), $this->get('dbal.conn'), $this->get('cache'), $this->get('language'), $this->get('user'), 'phpbb2_notification_types', 'phpbb2_user_notifications');
    }
    ...
    {
        return $this->services['profilefields.lang_helper'] = new \phpbb\profilefields\lang_helper($this->get('dbal.conn'), 'phpbb2_profile_fields_lang');
    }
    ...
    {
        return $this->services['profilefields.manager'] = new \phpbb\profilefields\manager($this->get('auth'), $this->get('dbal.conn'), $this->get('dispatcher'), $this->get('request'), $this->get('template'), $this->get('profilefields.type_collection'), $this->get('user'), 'phpbb2_profile_fields', 'phpbb2_profile_lang', 'phpbb2_profile_fields_data');
    }
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000003c2f96d1000000007806776e(
    ...
    {
        return $this->services['text_formatter.data_access'] = new \phpbb\textformatter\data_access($this->get('dbal.conn'), 'phpbb2_bbcodes', 'phpbb2_smilies', 'phpbb2_styles', 'phpbb2_words', './styles/');
    }
    ...
    {
        $this->services['text_reparser.forum_description'] = $instance = new \phpbb\textreparser\plugins\forum_description($this->get('dbal.conn'), 'phpbb2_forums');
    ...
    {
        $this->services['text_reparser.forum_rules'] = $instance = new \phpbb\textreparser\plugins\forum_rules($this->get('dbal.conn'), 'phpbb2_forums');
    ...
    {
        $this->services['text_reparser.group_description'] = $instance = new \phpbb\textreparser\plugins\group_description($this->get('dbal.conn'), 'phpbb2_groups');
    ...
    {
        $this->services['text_reparser.pm_text'] = $instance = new \phpbb\textreparser\plugins\pm_text($this->get('dbal.conn'), 'phpbb2_privmsgs');
    ...
    {
        $this->services['text_reparser.poll_title'] = $instance = new \phpbb\textreparser\plugins\poll_title($this->get('dbal.conn'), 'phpbb2_topics');
    ...
    {
        $this->services['text_reparser.post_text'] = $instance = new \phpbb\textreparser\plugins\post_text($this->get('dbal.conn'), 'phpbb2_posts');
    ...
    {
        $this->services['text_reparser.user_signature'] = $instance = new \phpbb\textreparser\plugins\user_signature($this->get('dbal.conn'), 'phpbb2_users');
    ...
    {
        return $this->services['user_loader'] = new \phpbb\user_loader($this->get('dbal.conn'), './', 'php', 'phpbb2_users');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'tables.acl_groups' => 'phpbb2_acl_groups',
            'tables.acl_options' => 'phpbb2_acl_options',
            'tables.acl_roles' => 'phpbb2_acl_roles',
            'tables.acl_roles_data' => 'phpbb2_acl_roles_data',
            'tables.acl_users' => 'phpbb2_acl_users',
            'tables.attachments' => 'phpbb2_attachments',
            'tables.auth_provider_oauth_token_storage' => 'phpbb2_oauth_tokens',
            'tables.auth_provider_oauth_states' => 'phpbb2_oauth_states',
            'tables.auth_provider_oauth_account_assoc' => 'phpbb2_oauth_accounts',
            'tables.banlist' => 'phpbb2_banlist',
            'tables.bbcodes' => 'phpbb2_bbcodes',
            'tables.bookmarks' => 'phpbb2_bookmarks',
            'tables.bots' => 'phpbb2_bots',
            'tables.captcha_qa_questions' => 'phpbb2_captcha_questions',
            'tables.captcha_qa_answers' => 'phpbb2_captcha_answers',
            'tables.captcha_qa_confirm' => 'phpbb2_qa_confirm',
            'tables.config' => 'phpbb2_config',
            'tables.config_text' => 'phpbb2_config_text',
            'tables.confirm' => 'phpbb2_confirm',
            'tables.disallow' => 'phpbb2_disallow',
            'tables.drafts' => 'phpbb2_drafts',
            'tables.ext' => 'phpbb2_ext',
            'tables.extensions' => 'phpbb2_extensions',
            'tables.extension_groups' => 'phpbb2_extension_groups',
            'tables.forums' => 'phpbb2_forums',
            'tables.forums_access' => 'phpbb2_forums_access',
            'tables.forums_track' => 'phpbb2_forums_track',
            'tables.forums_watch' => 'phpbb2_forums_watch',
            'tables.groups' => 'phpbb2_groups',
            'tables.icons' => 'phpbb2_icons',
            'tables.lang' => 'phpbb2_lang',
            'tables.log' => 'phpbb2_log',
            'tables.login_attempts' => 'phpbb2_login_attempts',
            'tables.migrations' => 'phpbb2_migrations',
            'tables.moderator_cache' => 'phpbb2_moderator_cache',
            'tables.modules' => 'phpbb2_modules',
            'tables.notification_types' => 'phpbb2_notification_types',
            'tables.notifications' => 'phpbb2_notifications',
            'tables.poll_options' => 'phpbb2_poll_options',
            'tables.poll_votes' => 'phpbb2_poll_votes',
            'tables.posts' => 'phpbb2_posts',
            'tables.privmsgs' => 'phpbb2_privmsgs',
            'tables.privmsgs_folder' => 'phpbb2_privmsgs_folder',
            'tables.privmsgs_rules' => 'phpbb2_privmsgs_rules',
            'tables.privmsgs_to' => 'phpbb2_privmsgs_to',
            'tables.profile_fields' => 'phpbb2_profile_fields',
            'tables.profile_fields_data' => 'phpbb2_profile_fields_data',
            'tables.profile_fields_options_language' => 'phpbb2_profile_fields_lang',
            'tables.profile_fields_language' => 'phpbb2_profile_lang',
            'tables.ranks' => 'phpbb2_ranks',
            'tables.reports' => 'phpbb2_reports',
            'tables.reports_reasons' => 'phpbb2_reports_reasons',
            'tables.search_results' => 'phpbb2_search_results',
            'tables.search_wordlist' => 'phpbb2_search_wordlist',
            'tables.search_wordmatch' => 'phpbb2_search_wordmatch',
            'tables.sessions' => 'phpbb2_sessions',
            'tables.sessions_keys' => 'phpbb2_sessions_keys',
            'tables.sitelist' => 'phpbb2_sitelist',
            'tables.smilies' => 'phpbb2_smilies',
            'tables.sphinx' => 'phpbb2_sphinx',
            'tables.styles' => 'phpbb2_styles',
            'tables.styles_template' => 'phpbb2_styles_template',
            'tables.styles_template_data' => 'phpbb2_styles_template_data',
            'tables.styles_theme' => 'phpbb2_styles_theme',
            'tables.styles_imageset' => 'phpbb2_styles_imageset',
            'tables.styles_imageset_data' => 'phpbb2_styles_imageset_data',
            'tables.teampage' => 'phpbb2_teampage',
            'tables.topics' => 'phpbb2_topics',
            'tables.topics_posted' => 'phpbb2_topics_posted',
            'tables.topics_track' => 'phpbb2_topics_track',
            'tables.topics_watch' => 'phpbb2_topics_watch',
            'tables.user_group' => 'phpbb2_user_group',
            'tables.user_notifications' => 'phpbb2_user_notifications',
            'tables.users' => 'phpbb2_users',
            'tables.warnings' => 'phpbb2_warnings',
            'tables.words' => 'phpbb2_words',
            'tables.zebra' => 'phpbb2_zebra',
...
class phpbbtemplatetwiglexer_000000003c2f96d1000000007806776e extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder618b474713e90012744298 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer618b474713e94886582861 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties618b474713e80865919995 = array(
    ...
    {
        $this->initializer618b474713e94886582861 && ($this->initializer618b474713e94886582861->__invoke($valueHolder618b474713e90012744298, $this, 'set_environment', array('env' => $env), $this->initializer618b474713e94886582861) || 1) && $this->valueHolder618b474713e90012744298 = $valueHolder618b474713e90012744298;

        return $this->valueHolder618b474713e90012744298->set_environment($env);
    }
    ...
    {
        $this->initializer618b474713e94886582861 && ($this->initializer618b474713e94886582861->__invoke($valueHolder618b474713e90012744298, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer618b474713e94886582861) || 1) && $this->valueHolder618b474713e90012744298 = $valueHolder618b474713e90012744298;

        return $this->valueHolder618b474713e90012744298->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer618b474713e94886582861 && ($this->initializer618b474713e94886582861->__invoke($valueHolder618b474713e90012744298, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer618b474713e94886582861) || 1) && $this->valueHolder618b474713e90012744298 = $valueHolder618b474713e90012744298;

        return $this->valueHolder618b474713e90012744298->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer618b474713e94886582861 = $initializer;
    }
    ...
    {
        $this->initializer618b474713e94886582861 && ($this->initializer618b474713e94886582861->__invoke($valueHolder618b474713e90012744298, $this, '__get', array('name' => $name), $this->initializer618b474713e94886582861) || 1) && $this->valueHolder618b474713e90012744298 = $valueHolder618b474713e90012744298;

        if (isset(self::$publicProperties618b474713e80865919995[$name])) {
            return $this->valueHolder618b474713e90012744298->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder618b474713e90012744298;
    ...
    {
        $this->initializer618b474713e94886582861 && ($this->initializer618b474713e94886582861->__invoke($valueHolder618b474713e90012744298, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer618b474713e94886582861) || 1) && $this->valueHolder618b474713e90012744298 = $valueHolder618b474713e90012744298;
    ...
    {
        $this->initializer618b474713e94886582861 && ($this->initializer618b474713e94886582861->__invoke($valueHolder618b474713e90012744298, $this, '__isset', array('name' => $name), $this->initializer618b474713e94886582861) || 1) && $this->valueHolder618b474713e90012744298 = $valueHolder618b474713e90012744298;
    ...
    {
        $this->initializer618b474713e94886582861 && ($this->initializer618b474713e94886582861->__invoke($valueHolder618b474713e90012744298, $this, '__unset', array('name' => $name), $this->initializer618b474713e94886582861) || 1) && $this->valueHolder618b474713e90012744298 = $valueHolder618b474713e90012744298;
    ...
    {
        $this->initializer618b474713e94886582861 && ($this->initializer618b474713e94886582861->__invoke($valueHolder618b474713e90012744298, $this, '__clone', array(), $this->initializer618b474713e94886582861) || 1) && $this->valueHolder618b474713e90012744298 = $valueHolder618b474713e90012744298;

        $this->valueHolder618b474713e90012744298 = clone $this->valueHolder618b474713e90012744298;
    }

    public function __sleep()
    {
        $this->initializer618b474713e94886582861 && ($this->initializer618b474713e94886582861->__invoke($valueHolder618b474713e90012744298, $this, '__sleep', array(), $this->initializer618b474713e94886582861) || 1) && $this->valueHolder618b474713e90012744298 = $valueHolder618b474713e90012744298;

        return array('valueHolder618b474713e90012744298');
    }
    ...
    {
        return $this->initializer618b474713e94886582861;
    }
    ...
    {
        return $this->initializer618b474713e94886582861 && ($this->initializer618b474713e94886582861->__invoke($valueHolder618b474713e90012744298, $this, 'initializeProxy', array(), $this->initializer618b474713e94886582861) || 1) && $this->valueHolder618b474713e90012744298 = $valueHolder618b474713e90012744298;
    }
    ...
    {
        return null !== $this->valueHolder618b474713e90012744298;
    }
    ...
    {
        return $this->valueHolder618b474713e90012744298;
    }
